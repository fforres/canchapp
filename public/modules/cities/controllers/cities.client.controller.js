...
// Cities controller
angular.module('cities').controller('CitiesController', ['$scope', '$stateParams', '$location', 'Authentication', 'Cities', 'Countries',
	function($scope, $stateParams, $location, Authentication, Cities, Countries) {
